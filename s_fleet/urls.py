...
urlpatterns = [
    ...
    path('manager/payments/<int:payment_id>/razorpay/', views.pay_driver_razorpay, name='pay_driver_razorpay'),
    path('manager/payments/<int:payment_id>/dummy/', views.pay_driver_dummy, name='pay_driver_dummy'),
    path('manager/payments/razorpay/callback/', views.razorpay_callback, name='razorpay_callback'),
    ...
    path('driver/trips/<int:trip_id>/location/', views.post_trip_location, name='post_trip_location'),
